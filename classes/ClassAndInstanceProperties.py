...
class SquadraCalcio:
    ...
    def squadre_attive(
        cls,
    ):  # definisce un metodo di classe. uso 'cls' al posto di 'self'
...
if __name__ == "__main__":
    ...
    print(
        s1
    )  # usa il dunder method __str__ Se __str__ non fosse dichiarato, nella print verrebbe usato __srepr__
    print(repr(s1))
